#ifndef		__ARCH_X86_GDT_H_
#define		__ARCH_X86_GDT_H_

#include	<stdint.h>

const uint16_t NULL_SELECTOR;
const uint16_t KCODE_SELECTOR;
const uint16_t KDATA_SELECTOR;

// A struct describing a Task State Segment.
typedef struct tagTSS_ENTRY
{
...
typedef struct tagGDT_ENTRY {
	...
	uint8_t		FlagsAndLimit;				//	Bits 48-55
