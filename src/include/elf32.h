...
typedef struct Elf32_Section_t_header {
	uint32_t sh_name;
	uint32_t sh_type;
	uint32_t sh_flags;
	uint32_t sh_addr;
...
typedef struct
{
  ...
  Elf32_Word_t	vda_next;		/* Offset in bytes to next verdaux entry */
} Elf32_Verdaux_t;
...
typedef struct
{
  ...
  Elf32_Word_t	vn_file;		/* Offset of filename for this dependency */
  Elf32_Word_t	vn_aux;			/* Offset in bytes to vernaux array */
  Elf32_Word_t	vn_next;		/* Offset in bytes to next verneed entry */
} Elf32_Verneed_t;
...
typedef struct
{
  ...
  Elf32_Word_t	vna_next;		/* Offset in bytes to next vernaux entry */
} Elf32_Vernaux_t;
...
typedef struct
{
  Elf32_Word_t hwp_flags1;	/* Extra flags.  */
  Elf32_Word_t hwp_flags2;	/* Extra flags.  */
} Elf_Options_Hw_t;
...
typedef Elf32_Addr_t Elf32_Conflict;
