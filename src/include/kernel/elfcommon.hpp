...
#define DT_RUNPATH \
	29	  //	String table offset of a null-terminated library search path
		  // string.
#define DT_FLAGS 30	   //	Object specific flag values.
#define DT_ENCODING \
	32	  // Values greater than or equal to DT_ENCODING and less than DT_LOOS
		  // follow the rules for the interpretation of the d_un union as
		  // follows: even == 'd_ptr', odd == 'd_val' or none
#define DT_PREINIT_ARRAY \
	32	  //	Address of the array of pointers to pre-initialization
		  // functions.
...
//	Values for DT_FLAGS
#define DF_ORIGIN \
	0x0001	  // Indicates that the object being loaded may make reference to
...
#define DF_BIND_NOW \
	0x0008	  //	Indicates that the dynamic linker should
			  //	process all relocations for the object containing this entry
			  //	before transferring control to the program.
#define DF_STATIC_TLS \
	0x0010	  // Indicates that the shared object or executable contains code
...
#define R_ARM_THM_XPC22		16	  //	TLS relocations
